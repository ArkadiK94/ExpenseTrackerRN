...
const ExpensesContextProvider = ({ children }) => {
  const [expenses, setExpenses] = useState([
    new Expense(1, "Test", 19.99, "2022-07-22"),
    new Expense(2, "A pair of shoes", 59.99, "2021-12-19"),
    new Expense(3, "A pair of trousers", 89.29, "2022-01-05"),
    new Expense(4, "Some bananas", 5.99, "2021-12-01"),
    new Expense(5, "Cafe", 9.99, "2022-07-20"),
